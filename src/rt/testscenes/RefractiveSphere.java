...
public class RefractiveSphere extends Scene {
	...
	public RefractiveSphere()
	{
		...
		XYZGrid grid = new XYZGrid(new Spectrum(0.4f, 0.f, 0.f), new Spectrum(1.f, 1.f, 1.f), 0.01f, new Vector3f(0.f, 0.f, 0.f), 0.125f);
		Plane backPlane = new Plane(new Vector3f(0.f, 0.f, 1.f), 2.15f);
		backPlane.material = grid;
		
		// A sphere for testing
		Sphere sphere = new Sphere();
//		CSGSphere sphere = new CSGSphere(new Vector3f(0.f, 0.f, 0.f), 1f);
		...
		LightGeometry pointLight1 = new PointLight(lightPos, new Spectrum(24.f, 24.f, 24.f));
		lightPos.add(new Vector3f(2.f, 0.f, 0.f));
		LightGeometry pointLight2 = new PointLight(lightPos, new Spectrum(24.f, 24.f, 24.f));
		LightGeometry pointLight3 = new PointLight(new Vector3f(0.f, 7.f, 0.f), new Spectrum(24.f, 24.f, 24.f));
